...
export interface ApiHompageHompage extends Struct.SingleTypeSchema {
  collectionName: 'hompages';
  info: {
    displayName: 'Homepage';
    pluralName: 'hompages';
    singularName: 'hompage';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroslide: Schema.Attribute.Component<'homepage.hero-slide', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::hompage.hompage'
    ...
    populardestinations: Schema.Attribute.Component<
      ...
      false
    >;
    populartours: Schema.Attribute.Component<'homepage.popular-tours', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::hompage.hompage': ApiHompageHompage;
